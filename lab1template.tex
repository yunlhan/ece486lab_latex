...
\title{\bf Lab \#1 Report\\{\sc Simulation Using the Analog Computer}}
...
\begin{table}[phtb] \label{tbl:lab1_q1}
  \begin{center}
    ...
    \begin{tabular}{c|rr|rr|rr} \hline \hline
      & \multicolumn{2}{c}{$M_p$ (\%)} & \multicolumn{2}{c}{$t_p$ (s)} & \multicolumn{2}{c}{$t_s$ (s)} \\ \cline{2-7} % horizontal line spanning across specified columns
